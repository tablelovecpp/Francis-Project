...
Camera_WorldToScreen(const Camera *cam, const CameraObject *obj, int w, int h) {
...
/* 直接给 SDL_Rect 的版本（整数） */
static inline SDL_Rect Camera_WorldToScreenRect(const Camera *cam,
                                                const CameraObject *obj, int w,
                                                int h) {
